...
- ### Effect on District Summary:
  - The total number of schools, students and total budget for the district remained the same (as these metrics were based on school ID and not grades).
...
- ### Effect on School Summary:
  ...
  - By replacing the math and reading scores of ninth graders in Thomas High School to null values, the overall passing percentage came down significantly from 91% to 65%. 
  - The school's passing math and reading percentages also dropped over 25%.
  - The average math and reading scores did not change much.
<table>
...
<tr>
  ...
  <td>Adjusted Rank of Thomas High School</td>
</tr>
<tr>
  <td><img src="Resources/Original_Rank.png" width="800"/>
  <td><img src="Resources/Adjusted_Rank.png" width="800"/>
</tr>
</table>

- ### Effect on Grade level Math and Reading scores:
  - The adjusted metrics were calculated by considering the total number of 10th - 12th grade students in Thomas High School.
  - Thomas High School had 83.6 as average math score for the ninth grade tests initially while the adjusted showed as null values represented as "nan" in Python.
  - The school also had 83.7 as average reading score for ninth grade tests intially. The adjustments showed null values in the same category.
...
- The school's ranking dropped from 2nd to 8th in the school district of 15 schools.
